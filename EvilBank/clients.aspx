                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <div class="table-responsive">
                                <asp:DataGrid OnRowCommand="GridView1_RowCommand" DataKeyNames="id" CssClass="table table-hover table-striped w-100" ID="DataGrid1" runat="server" DataSourceID="bankdb" Width="500px" Height="214px" CellPadding="5" BorderWidth="5px" GridLines="both" CaptionAlign="Bottom" HorizontalAlign="Center" CellSpacing="5" AutoGenerateColumns="True" BorderStyle="Solid" HeaderStyle-BorderStyle="Solid" UseAccessibleHeader="True">
                                    <Columns>
                                        <asp:TemplateColumn HeaderText="Handlers" ItemStyle-CssClass="d-flex">
                                            <ItemTemplate>
                                                <asp:Button class="btn btn-primary py-2 w-100 mb-4" ID="btnDelete" runat="server" Text="Delete" OnClick="btnDelete_Click" />
                                                <asp:Button class="btn btn-primary py-2 w-100 mb-4" ID="Button1" runat="server" Text="Edit" OnClick="btnEdit_Click" />
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                    </Columns>
                                </asp:DataGrid>
                                <asp:SqlDataSource ID="bankdb" runat="server" ConnectionString="<%$ ConnectionStrings:bankdbConnectionString %>" SelectCommand="SELECT * FROM [users]"></asp:SqlDataSource>
                            </div>
                        </div>
                        &nbsp;
                    </div>
